...
/***/ function(module, exports, __webpack_require__) {
	...
	var KartData = __webpack_require__(6);
	var kartBuilder = __webpack_require__(12);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Nuclear = __webpack_require__(5);
...
/***/ function(module, exports, __webpack_require__) {
	...
	Flux.registerStores({
	  KartData: __webpack_require__(7)
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var KARTS_DATA = __webpack_require__(8);
	var WHEELS_DATA = __webpack_require__(9);
	var GLIDERS_DATA = __webpack_require__(10);
	...
	module.exports = [
		{
			...
			"Speed - Water": 0,
			"Speed - Air": 0,
			"Speed - Anti-Gravity": 0,
			"Acceleration": 0,
			"Weight": 0,
			"Handling - Ground": 0,
			"Handling - Water": 0,
			"Handling - Air": 0,
			"Handling - Anti-Gravity": 0,
			"Traction": 0,
			"Mini-Turbo": 0
		},
		{
			...
			"Speed - Water": 0.25,
			"Speed - Air": 0.25,
			"Speed - Anti-Gravity": -0.25,
			"Acceleration": 0.25,
			"Weight": -0.25,
			"Handling - Ground": 0.5,
			"Handling - Water": 0.5,
			"Handling - Air": 0.5,
			"Handling - Anti-Gravity": 0.25,
			"Traction": -0.5,
			"Mini-Turbo": 0.25
		},
		{
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  ...
	  components: {
	    'kart-component': __webpack_require__(14)
	  },
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = "<style>\n.kart-component {\n  width: 400px;\n  border: 1px;\n}\n\n.kart-component th, .kart-component td {\nfont-size: 10px;\npadding: 5px;\n}\n</style>\n<table class=\"kart-component\">\n  <thead>\n    <tr>\n      <th>Name</th>\n      <th>Speed - Ground</th>\n      <th>Speed - Water</th>\n      <th>Speed - Air</th>\n      <th>Speed - Anti-Gravity</th>\n      <th>Acceleration</th>\n      <th>Weight</th>\n      <th>Handling - Ground</th>\n      <th>Handling - Water</th>\n      <th>Handling - Air</th>\n      <th>Handling - Anti-Gravity</th>\n      <th>Traction</th>\n      <th>Mini-Turbo</th>\n    </tr>\n  </thead>\n  <tbody>\n    <tr>\n      <td>{{ component[\"Name\"] }}</td>\n      <td>{{ component[\"Speed - Ground\"] }}</td>\n      <td>{{ component[\"Speed - Water\"] }}</td>\n      <td>{{ component[\"Speed - Air\"] }}</td>\n      <td>{{ component[\"Speed - Anti-Gravity\"] }}</td>\n      <td>{{ component[\"Acceleration\"] }}</td>\n      <td>{{ component[\"Weight\"] }}</td>\n      <td>{{ component[\"Handling - Ground\"] }}</td>\n      <td>{{ component[\"Handling - Water\"] }}</td>\n      <td>{{ component[\"Handling - Air\"] }}</td>\n      <td>{{ component[\"Handling - Anti-Gravity\"] }}</td>\n      <td>{{ component[\"Traction\"] }}</td>\n      <td>{{ component[\"Mini-Turbo\"] }}</td>\n    </tr>\n  </tbody>\n</table>\n";
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = "<style>\n.kart-component {\n  width: 400px;\n  border: 1px;\n}\n\n.kart-component th, .kart-component td {\nfont-size: 10px;\npadding: 5px;\n}\n</style>\n\n<div class=\"kart-builder\">\n  <div>\n    <h3>Kart</h3>\n    <table class=\"kart-component\">\n      <thead>\n        <tr>\n          <th>Name</th>\n          <th>Speed - Ground</th>\n          <th>Speed - Water</th>\n          <th>Speed - Air</th>\n          <th>Speed - Anti-Gravity</th>\n          <th>Acceleration</th>\n          <th>Weight</th>\n          <th>Handling - Ground</th>\n          <th>Handling - Water</th>\n          <th>Handling - Air</th>\n          <th>Handling - Anti-Gravity</th>\n          <th>Traction</th>\n          <th>Mini-Turbo</th>\n        </tr>\n      </thead>\n      <tbody>\n        <tr v-repeat=\"component: karts\" v-on=\"click: selectComponent('kart', component)\">\n          <td>{{ component[\"Name\"] }}</td>\n          <td>{{ component[\"Speed - Ground\"] }}</td>\n          <td>{{ component[\"Speed - Water\"] }}</td>\n          <td>{{ component[\"Speed - Air\"] }}</td>\n          <td>{{ component[\"Speed - Anti-Gravity\"] }}</td>\n          <td>{{ component[\"Acceleration\"] }}</td>\n          <td>{{ component[\"Weight\"] }}</td>\n          <td>{{ component[\"Handling - Ground\"] }}</td>\n          <td>{{ component[\"Handling - Water\"] }}</td>\n          <td>{{ component[\"Handling - Air\"] }}</td>\n          <td>{{ component[\"Handling - Anti-Gravity\"] }}</td>\n          <td>{{ component[\"Traction\"] }}</td>\n          <td>{{ component[\"Mini-Turbo\"] }}</td>\n        </tr>\n      </tbody>\n    </table>\n  </div>\n  <div>\n    <h3>Wheels</h3>\n    <table class=\"kart-component\">\n      <thead>\n        <tr>\n          <th>Name</th>\n          <th>Speed - Ground</th>\n          <th>Speed - Water</th>\n          <th>Speed - Air</th>\n          <th>Speed - Anti-Gravity</th>\n          <th>Acceleration</th>\n          <th>Weight</th>\n          <th>Handling - Ground</th>\n          <th>Handling - Water</th>\n          <th>Handling - Air</th>\n          <th>Handling - Anti-Gravity</th>\n          <th>Traction</th>\n          <th>Mini-Turbo</th>\n        </tr>\n      </thead>\n      <tbody>\n        <tr v-repeat=\"component: wheels\" v-on=\"click: selectComponent('wheels', component)\">\n          <td>{{ component[\"Name\"] }}</td>\n          <td>{{ component[\"Speed - Ground\"] }}</td>\n          <td>{{ component[\"Speed - Water\"] }}</td>\n          <td>{{ component[\"Speed - Air\"] }}</td>\n          <td>{{ component[\"Speed - Anti-Gravity\"] }}</td>\n          <td>{{ component[\"Acceleration\"] }}</td>\n          <td>{{ component[\"Weight\"] }}</td>\n          <td>{{ component[\"Handling - Ground\"] }}</td>\n          <td>{{ component[\"Handling - Water\"] }}</td>\n          <td>{{ component[\"Handling - Air\"] }}</td>\n          <td>{{ component[\"Handling - Anti-Gravity\"] }}</td>\n          <td>{{ component[\"Traction\"] }}</td>\n          <td>{{ component[\"Mini-Turbo\"] }}</td>\n        </tr>\n      </tbody>\n    </table>\n  </div>\n  <div>\n    <h3>Glider</h3>\n    <table class=\"kart-component\">\n      <thead>\n        <tr>\n          <th>Name</th>\n          <th>Speed - Ground</th>\n          <th>Speed - Water</th>\n          <th>Speed - Air</th>\n          <th>Speed - Anti-Gravity</th>\n          <th>Acceleration</th>\n          <th>Weight</th>\n          <th>Handling - Ground</th>\n          <th>Handling - Water</th>\n          <th>Handling - Air</th>\n          <th>Handling - Anti-Gravity</th>\n          <th>Traction</th>\n          <th>Mini-Turbo</th>\n        </tr>\n      </thead>\n      <tbody>\n        <tr v-repeat=\"component: gliders\" v-on=\"click: selectComponent('glider', component)\">\n          <td>{{ component[\"Name\"] }}</td>\n          <td>{{ component[\"Speed - Ground\"] }}</td>\n          <td>{{ component[\"Speed - Water\"] }}</td>\n          <td>{{ component[\"Speed - Air\"] }}</td>\n          <td>{{ component[\"Speed - Anti-Gravity\"] }}</td>\n          <td>{{ component[\"Acceleration\"] }}</td>\n          <td>{{ component[\"Weight\"] }}</td>\n          <td>{{ component[\"Handling - Ground\"] }}</td>\n          <td>{{ component[\"Handling - Water\"] }}</td>\n          <td>{{ component[\"Handling - Air\"] }}</td>\n          <td>{{ component[\"Handling - Anti-Gravity\"] }}</td>\n          <td>{{ component[\"Traction\"] }}</td>\n          <td>{{ component[\"Mini-Turbo\"] }}</td>\n        </tr>\n      </tbody>\n    </table>\n  </div>\n  <hr>\n  <div>\n    <h3>Totals</h3>\n    <table class=\"kart-component\">\n      <thead>\n        <tr>\n          <th>Name</th>\n          <th>Speed - Ground</th>\n          <th>Speed - Water</th>\n          <th>Speed - Air</th>\n          <th>Speed - Anti-Gravity</th>\n          <th>Acceleration</th>\n          <th>Weight</th>\n          <th>Handling - Ground</th>\n          <th>Handling - Water</th>\n          <th>Handling - Air</th>\n          <th>Handling - Anti-Gravity</th>\n          <th>Traction</th>\n          <th>Mini-Turbo</th>\n        </tr>\n      </thead>\n      <tbody>\n        <tr v-repeat=\"component: currentKart\">\n          <td>{{ component[\"Name\"] }}</td>\n          <td>{{ component[\"Speed - Ground\"] }}</td>\n          <td>{{ component[\"Speed - Water\"] }}</td>\n          <td>{{ component[\"Speed - Air\"] }}</td>\n          <td>{{ component[\"Speed - Anti-Gravity\"] }}</td>\n          <td>{{ component[\"Acceleration\"] }}</td>\n          <td>{{ component[\"Weight\"] }}</td>\n          <td>{{ component[\"Handling - Ground\"] }}</td>\n          <td>{{ component[\"Handling - Water\"] }}</td>\n          <td>{{ component[\"Handling - Air\"] }}</td>\n          <td>{{ component[\"Handling - Anti-Gravity\"] }}</td>\n          <td>{{ component[\"Traction\"] }}</td>\n          <td>{{ component[\"Mini-Turbo\"] }}</td>\n        </tr>\n      </tbody>\n    </table>\n  </div>\n  \n</div>\n";
...
/***/ function(module, exports, __webpack_require__) {
	...
	// register stores with Flux system
	Flux.registerStores({
	  currentKart: __webpack_require__(17)
	});

	module.exports = {
	  actions: __webpack_require__(20),

	  fns: __webpack_require__(28),

	  getters: __webpack_require__(29)
	};
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	function selectComponent(state, _ref) {
	  var part = _ref.part;
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.initialize = function () {
	  ...
	  // setup persistence
	  Flux.observe(_.debounce(function (state) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var toImmutable = __webpack_require__(5).toImmutable;
	...
	exports.currentKart = [['currentKart'], function (currentKart) {
	  var totals = [currentKart.get('kart'), currentKart.get('wheels'), currentKart.get('glider')].filter(function (f) {
	    return !!f;
	  }).reduce(function (totals, val) {
